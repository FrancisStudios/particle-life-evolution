...
## ⬇️ Downloads
🐧 [Linux (pre-release v0.4.3)](./dist/linux/)

🪟 [Windows (pre-release v0.4.3)](./dist/windows/)
...
### Notes:
Finally the simulation can be started and stopped in the recent versions, and attraction forces are working as intended - `can be configured through sim.config.json`

![screenshot](./docs/screenshot2.png)

Older releases: Entities can be rendered and built properly - ready for rendering
![screenshot](./docs/screenshot.png)

Simulation config documentation will be available soon!